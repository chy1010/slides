...
\begin{frame}
	...
	% The ids are nominal values. 
	% Ground-truth ids may not have any coincidence with the tracker ids.
...
\begin{frame}
	...
	% \begin{itemize}
	% \item The matching is also done according to similarity scores between trajectories.
	% 	Again, there may be many possibilities.
	% \item Similarity scores between trajectories still depend on matching in detection levels.
	% \end{itemize}
